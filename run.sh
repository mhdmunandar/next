...
awk -v ip="$lan_ip" '/0 => '\''localhost'\''/{print; print "    1 => '\''"nextcloud.mm62.online"'\'',"; next}1' /DATA/AppData/big-bear-nextcloud/html/config/config.php.bak > /DATA/AppData/big-bear-nextcloud/html/config/config.php
